...
<template>
  <div class="pt-3x max-w-screen-lg mx-auto">
    <div class="px-2x pb-4x pt-4x lg:pt-8x 2xl:pt-11x relative z-10">
      <div class="flex items-center justify-center" style="background:rgba(255,255,255,0.8);width:fit-content;margin-left:auto;margin-right:auto;padding:10px 10px 0 10px;">
        <img :src="`${ assets }/unpathdwaters-landscape-logo.png`"
          alt="ariadne logo"
          class="mb-xl"
        />
      </div>
